...
var musicList = document.getElementById("listMusic").addEventListener("click", function () {
    userInput.classList.add("displayNone");
    container.classList.remove("displayNone");
});

var musicAdd = document.getElementById("addMusic").addEventListener("click", function () {
